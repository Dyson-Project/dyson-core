package org.dyson.core.modelling.command;
...
public class AggregateRepository<T> extends LockingRepository<T, AnnotatedAggregate<T>> {
    ...
    public static class Builder<T> extends LockingRepository.Builder<T> {
        ...
        @Override
        public Builder<T> parameterResolverFactory(@NotNull ParameterResolverFactory parameterResolverFactory) {
            super.parameterResolverFactory(parameterResolverFactory);
            return this;
        }

        @Override
        public Builder<T> handlerDefinition(@NotNull HandlerDefinition handlerDefinition) {
            super.handlerDefinition(handlerDefinition);
            return this;
        }

        @Override
        public Builder<T> aggregateModel(@NotNull AggregateModel<T> aggregateModel) {
        ...
        @Override
        public Builder<T> subtypes(@NotNull Set<Class<? extends T>> subtypes) {
            super.subtypes(subtypes);
            return this;
        }

        @Override
        public Builder<T> subtype(@NotNull Class<? extends T> subtype) {
